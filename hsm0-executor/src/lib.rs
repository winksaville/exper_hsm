...
pub struct StateMachineExecutorBuilder<SM, P> {
...
mod test {
    ...
    fn test_sm_1s_no_enter_no_exit() {
        ...
        impl StateMachine {
            #[no_coverage]
            fn new() -> StateMachineExecutorBuilder<Self, NoMessages> {
    ...
    fn test_sm_1s_enter_no_exit() {
        ...
        impl StateMachine {
            #[no_coverage]
            fn new() -> StateMachineExecutorBuilder<Self, Message> {
                let sm = StateMachine { state: 0 };
                let mut sme = StateMachineExecutorBuilder::new(sm, MAX_STATES);
